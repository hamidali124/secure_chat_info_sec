...
4. **Generate certificates** (after implementing the scripts):
   ```bash
...
6. **Testing Replay and FlipBit Attack**
   Input this at client side:
   ```bash
   /r #for replay attack
   /f #for flip bit attack
   ```

7. **Transcript verification**
   Update the reciept name in app/transcript_check.py and then run:
   ```bash
   python app/transcript_check.py
   ```
...
## Test Evidence
1. Certificate Verification - Successful
![Alt text](screenshots/certf_ok.png)

2. Bad Certificate - Tampered certificate's last bit
![Alt text](screenshots/certf_bad.png)

3. Wireshark Intercept - Encrypted Payloads
![Alt text](screenshots/Client_Encrypted_Message.png)

4. Replay,FlipBit Attack Test - Successfully caught using sequence numbers, signed hash
![Alt text](screenshots/Replay_Attack_Flip_Bit_Attack.png)

5. Reciept Check - Pass
![Alt text](screenshots/Reciept_Check_Pass.png)

6. Reciept Check - Fail
![Alt text](screenshots/Reciept_Check_Fail.png)
